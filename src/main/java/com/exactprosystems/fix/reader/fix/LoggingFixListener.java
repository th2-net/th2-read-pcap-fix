...
public class LoggingFixListener implements FixListener{
    private static final Logger log = LoggerFactory.getLogger(LoggingFixListener.class);
    ...
    public long onMessagesRead(boolean isClientFrame, FixMessage msg, Pcap associatedPacket, boolean saveToDb) throws IOException {
        log.debug("\n");
        log.debug("[{}] DATA[{}] {}", isClientFrame ? "CLIENT" : "SERVER", msg.getData());
        return 0;
    }
}
